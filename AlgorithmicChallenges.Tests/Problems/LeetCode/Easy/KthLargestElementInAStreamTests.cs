...
namespace AlgorithmicChallenges.Tests.Problems.LeetCode.Easy
{
    ...
    {
        [TestCase(3, new[] { 4, 5, 8, 2 }, new[] { 3, 5, 10, 9, 4 }, ESolutionType.MySolution, ExpectedResult = new[] { 4, 5, 5, 8, 8 })]
        [TestCase(3, new[] { 4, 5, 8, 2 }, new[] { 3, 5, 10, 9, 4 }, ESolutionType.Best, ExpectedResult = new[] { 4, 5, 5, 8, 8 })]
